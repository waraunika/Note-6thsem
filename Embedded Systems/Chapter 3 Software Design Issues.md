...
### 2.1.1 The Five Stages of Instruction Execution
#### 2.1.1.1 Fetch Instruction
...
### 2.2.2 Conditions for an Efficient Pipeline
...
### 2.2.3 Challenge: The Branch Hazard
...
### 2.2.4 Example: A 5-Stage Instruction Pipeline
...
## 2.3 Superscalar and Very Long Instruction Architectures
...
## 4.1 Tool for Implementation Phase
1. Assembler
...
## 4.2 Tools for Verification Phase
1. Debuggers
...
## 4.4 Embedded System Development Process
...
### 6.1.1 Key Factors in Processor Selection
#### 6.1.1.1 Technical Aspects
...
---
### 6.1.2 Comparing Processor Speed
...
#### 6.1.2.2 Instructions Per Second (IPS)
...
## 7.1 Not asked in exam, so skipped for now