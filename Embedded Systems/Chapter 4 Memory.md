...
### 1.2.1 The Spectrum
#### 1.2.1.1 Low End: The Refresh Required Tier
...
#### 1.2.1.2 Lower Range: The Power-On Dependent Tier
...
#### 1.2.1.3 Middle Range: The Long-Term Retention Tier
...
#### 1.2.1.4 High End: The Permanent Tier
...
## 3.1 Case 1: to increase the width of words.
...
### 3.1.1 Example 1: Compose 1K x 8 ROMs into 1K x 32 ROM
...
## 3.2 Case 2: To increase the number of words
...
### 3.2.1 Example 2: Compose 1K x 8 ROMs into a 4K x 8 ROM
...
## 3.3 Case 3 To increase both, number of words and word width
...
### 3.3.1 Example 3: Compose 1 K x 8 ROMs into a 4K x 16 ROM
...
### 4.2.1 Cache Mapping Techniques
...
#### 4.2.1.2 Fully Associative mapping
...
#### 4.2.1.3 Set Associative Mapping
...
### 4.2.2 Cache-Replacement Policy
...
### 4.2.4 Cache Impact on System Performance
...
#### 4.2.4.2 Degree of associativity
