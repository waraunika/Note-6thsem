...
- Universality:
	- The fundamentals of project management remain the same regardless of the industry - whether construction, software, engineering or automotive.
- Uniqueness:
	- Many concepts within PMBOK are unique to project management, such as:
	- CPM, PERT, WBS, EVA
- Overlap:
...
| **2. Planning**                 | Establishes the scope, refines objectives, and defines the course of action required to achieve the project goals. This is where the project management plan is created. |
| **3. Executing**                | Involves completing the work defined in the project management plan to satisfy the project requirements. This is where the actual deliverables are produced.             |
| **4. Monitoring & Controlling** | Tracks, reviews, and regulates the progress and performance of the project. It involves identifying variances and implementing corrective actions.                       |
| **5. Closing**                  | Finalizes all activities across all process groups to formally complete the project or phase. This includes handing over deliverables and releasing resources.           |
- Process Groups are a logical grouping of project management processes.
- They are not discrete phases but are iterative and can occur at different times throughout the project.
- each process is defined by 3 components:
	- Input: 
		- the document, plans, designs or artifacts that are needed to start the process
	- tools & techniques:
...
| PESTLE Factor               | Examples                                                                                             |
| --------------------------- | ---------------------------------------------------------------------------------------------------- |
| **Political**               | Political stability, government systems, institutional philosophies, policies.                       |
| **Economic**                | Economic systems, inflation rates, interest rates, market conditions, regional trade groups.         |
| **Socio-Cultural**          | Demographics, cultural norms, social institutions, pressure groups, lifestyle changes.               |
...
- These skills span various functional areas:
	...
	- **Organizing:** Structuring the project team and resources.
	- **Staffing:** Recruitment, promotion, transfer, and resource allocation.
	- **Coordinating:** Aligning activities across different teams and disciplines.
	- **Leading:** Setting direction, motivating, and influencing the team.
	- **Controlling:** Monitoring, evaluating, and implementing corrective actions.
...
| Is a visionary and decisive                           | Is confused and indecisive                             |
| Is technically competent                              | Lacks technical expertise                              |
...
- **Leadership:** Imparts a clear vision, gains consensus, inspires the team, and is self-assured.
- **Motivator:** Energizes people to overcome barriers and achieve high performance.
- **Result-Oriented:** Focuses on achieving the final project objectives, not just completing tasks.
...
- **Steps to Develop a Problem Tree:**
	...
	2. **Analyze** their interrelationship and identify common issues.
	3. **Determine** the core problem among the major problems (this becomes the central "trunk").
	4. **Write** the causes of the major problems (these become the "roots").
	5. **Write** the effects caused by the core problem (these become the "branches").
	6. **Form** a diagram showing the hierarchy: Causes → Core Problem → Effects.
	7. **Review** the diagram for validity and completeness. Iterate as needed.
- example figure:
	- Sample:
...
- **Decisive Role:** Making timely and critical decisions.
- **Information Role:** Acting as the central hub for communication and reporting.
**Responsibilities:**
- Project definition and charter development
- Project team building and development
- Stakeholder management and communication
- Project planning and design
- Project organization and governance design
...
- Project termination and closure management
