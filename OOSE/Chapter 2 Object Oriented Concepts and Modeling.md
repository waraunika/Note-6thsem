...
## OOS vs Procedural/Functional Oriented System
...
## Identifying Elements in Object Model
### Identifying Objects and Classes
#### Grammatical Parse Method:
1. underline each noun/noun clause in problem statement
2. Enter in a table
3. Note Synonyms
4. Filter using selection criteria
#### Categories of Objects to Look For:
...
### SafeHome Example: Object Identification
...
### Generic Life History Operations:
...
## Encapsulation & Inheritance: OO vs Conventional
...
## OO Design Cycle vs Conventional Design Cycle
